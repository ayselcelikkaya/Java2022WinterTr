...
public class UstaBasi extends Isci{
    ...
    String haklar="Ustabasi haftada bir gun tatil hakkina sahiptir";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(yasin.haklar);//Ustabasi haftada bir gun tatil hakkina sahiptir
        System.out.println(yasin.izin);//Tum personel yilda 4 hafta izin
