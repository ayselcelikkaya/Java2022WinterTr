...
public class C02_StaticVariabls {

    /*instance variable'lar objeye bagimlidir ve her objefarkli degerleralablir
    ogrenci notlari veya ogretmen branslari gibi
    bir objeye ait bir variale'in son degerini bulmak icin sadece o objeyi dikkate aliriz
   ...
   static String okulIsmi="Yildiz Koleji";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(okulIsmi);//Yildiz Kolej
