...
public class C05_Arrays {
    ...
    public static void main(String[] args) {
        ...
        //verilen bir array'e yeni bir element ekleyen bir metho olusturun

        int arr[]={3,5,7};

        //arr[3]=8; array'da olmayan bir indexe atama yapamayiz

        //arr={1,3,5,6} var olan bir array'e ayni boyutta bile olsa direk yeni degerler iceren bir deger atayamayiz
