...
public class C04_DateTimeFormatter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tarihSaat);//2022-03-31T22:40:12.234300300

        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MMMM/YYYY");//31/March/2022

        System.out.println(formatter.format(tarihSaat));

        DateTimeFormatter formatterSaat = DateTimeFormatter.ofPattern("HH : mm :ss a");
        System.out.println(formatterSaat.format(tarihSaat));//22 : 55 :37 PM
    }
}
     /*
         format olustururken
